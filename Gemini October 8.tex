...
\usepackage{tikz}
\usetikzlibrary{shapes, arrows.meta, positioning, shapes.geometric, arrows}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[node distance = 2cm, auto]
    ...
    \node [block, below of=start] (identify) {Identify Object Groupings};
    \node [block, below left of=identify, node distance=3cm] (dominant) {Dominant Group};
    \node [block, below of=identify] (subdominant) {Subdominant Group};
    \node [block, below right of=identify, node distance=3cm] (subordinate) {Subordinate Group};

    % Draw edges
    \path [line] (start) -- (identify);
    \path [line] (identify) -- (dominant);
    \path [line] (identify) -- (subdominant);
    \path [line] (identify) -- (subordinate);
  \end{tikzpicture}
